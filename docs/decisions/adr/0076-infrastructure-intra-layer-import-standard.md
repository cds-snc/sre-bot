...
2. **Remove B5 entirely (no intra-layer import rules):**
...
3. **Move all shared types to a single kernel package:**
...
2. Source title: Layers, Onions, Ports, Adapters: it's all the same
...
3. Source title: The Clean Architecture
...
4. Source title: Architecture Patterns with Python - Chapter 13: Dependency Injection (and Bootstrapping)
...
5. Source title: Django Contrib Packages (project structure reference)
...
6. Source title: Sentry project structure (large-scale Python monorepo reference)
...
7. Source title: Fowler - Inversion of Control Containers and the Dependency Injection pattern
...
8. Source title: ADR-0048 - Dependency and Import Boundary Constitution (internal)
