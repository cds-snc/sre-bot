...
class TestServiceLayerIdempotency:
    ...
    def test_add_member_cache_integration(self, mock_dispatch, mock_orch, mock_cache, mock_get_cache):
    ...
    @patch("modules.groups.service.event_system.dispatch_background")
    def test_remove_member_cache_integration(self, mock_dispatch, mock_orch, mock_cache, mock_get_cache):
