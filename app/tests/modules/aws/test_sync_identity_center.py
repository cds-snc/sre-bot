...
def test_synchronize_defaults_with_dry_run_true(
...
@patch("modules.aws.sync_identity_center.logger")
@patch("modules.aws.sync_identity_center.groups.preformat_groups")
...
def test_synchronize_sync_users_false_not_called(
    mock_get_groups_with_members_from_integration,
    ...
    response = sync_identity_center.synchronize(sync_users=False)
    ...
    assert (
        call(source_groups, target_groups, target_users)
...
def test_synchronize_sync_groups_false_not_called(
    mock_get_groups_with_members_from_integration,
    mock_get_unique_users_from_groups,
    mock_list_users,
    mock_sync_identity_center_users,
    ...
    assert (
        call(source_users, target_users)
...
def test_synchronize_sync_users_and_groups_false(
    mock_get_groups_with_members_from_integration,
    mock_get_unique_users_from_groups,
    mock_list_users,
    mock_sync_identity_center_users,
