...
from packages.geolocate.slack import handle_geolocate_command
...
def test_handle_geolocate_command_success():
    ...
    with patch("packages.geolocate.slack.geolocate_ip") as mock_service:
        mock_service.return_value = mock_result

        result = handle_geolocate_command(cmd)
