"""Unit tests for packages.access_catalog.transport.routes.
...
from packages.access_catalog.domain import (
    EntitlementEntry,
    ParsedEntitlementToken,
    PlatformSummary,
)
from packages.access_catalog.transport.routes import list_entitlements, list_platforms
