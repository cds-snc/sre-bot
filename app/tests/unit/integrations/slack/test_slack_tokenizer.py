...
class TestTokenizer:
    ...
    def test_tokenize_special_characters_in_quotes(self):
        ...
        parser = CommandArgumentParser([Argument(name="--justification", type=ArgumentType.STRING)])
    ...
    def test_real_world_groups_add_command(self):
        ...
        result = parser.parse('user@example.com my-group aws --justification "Emergency access for incident #123"')
    ...
    def test_tokenize_url_with_special_chars(self):
        ...
        parser = CommandArgumentParser([Argument(name="--url", type=ArgumentType.STRING)])
    ...
    def test_tokenize_json_in_quotes(self):
        ...
        parser = CommandArgumentParser([Argument(name="--data", type=ArgumentType.STRING)])
