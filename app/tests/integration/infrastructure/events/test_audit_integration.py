...
class TestAuditHandlerEventDispatch:
    ...
    def test_audit_handler_receives_dispatched_event(self):
        ...
        with patch(
            "infrastructure.events.handlers.audit.sentinel_client"
        ) as mock_sentinel:
            # Dispatch an event
            event = Event(
    ...
    def test_audit_handler_wildcard_registration(self):
        ...
        with patch(
            ...
            assert mock_sentinel.log_audit_event.call_count == 3

    def test_audit_handler_with_other_handlers(self):
    ...
    def test_audit_handler_converts_group_event_to_audit_event(self):
        ...
        with patch(
            ...
            audit_event: AuditEvent = mock_sentinel.log_audit_event.call_args[0][0]
    ...
    def test_audit_handler_converts_incident_event_to_audit_event(self):
...
class TestAuditEventCreation:
    ...
    def test_audit_event_captures_failure_details(self):
    ...
    def test_audit_event_flattens_metadata(self):
...
class TestSentinelIntegration:
    ...
    def test_sentinel_log_audit_event_called_with_audit_event(self):
    ...
    def test_audit_handler_logs_errors_when_sentinel_fails(self):
    ...
    def test_multiple_events_audit_trail(self):
        ...
        with patch(
            ...
            assert mock_log_audit.call_count == 3

            # Verify each audit event has correct action
            audit_events = [call[0][0] for call in mock_log_audit.call_args_list]
