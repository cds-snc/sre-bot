"""Standalone helpers for the incident documents subdomain.

Currently holds one helper (Google-Docs-URL ID extraction). If a Document
concept is ever promoted to a core infrastructure service behind a Protocol-
based adapter, this helper migrates with it rather than staying feature-local.
"""
