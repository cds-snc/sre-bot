...
#START_HEADING = "SRE Bot Automatically Generated Timeline\nA timeline generated by the SRE Bot by reacting to a message by using the  💾 emoji. Please DO NOT REMOVE this heading or this message that can be used for reference."
END_HEADING = "Trigger"
...
def replace_text_between_headings(doc_id, new_content, start_heading, end_heading):
    ...
    if start_index is not None and end_index is not None:
        # Format new content with new lines for proper insertion. We need tomake sure that the formatted string contains only one 
        ...
        core_content = new_content[leading_newlines: len(new_content) - trailing_newlines]
