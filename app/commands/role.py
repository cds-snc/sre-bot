...
def role_view_handler(ack, body, say, logger, client):
    ...
    recruitment_template_id = google_drive.copy_file_to_folder(
    ...
    logger.info(
        f"Created document: Recruitment Feedback Template in folder: Recruitment Feedback/ {recruitment_template_id}"
    ) 
