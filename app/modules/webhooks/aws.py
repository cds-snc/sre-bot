...
def handle_aws_sns_payload(payload: dict, client):
    """Handle the AWS SNS payload and return the blocks to be sent to Slack."""
    pass
...
def parse(payload: AwsSnsPayload, client): # get_payload_formatter
