from integrations.google_workspace import google_directory_next
...
def get_groups_from_integration(
    ...
    match integration_source:
        case "google_groups":
            ...
            groups_kwargs = {"query": query} if query else None
            groups = google_directory_next.list_groups_with_members(
