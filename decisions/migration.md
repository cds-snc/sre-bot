...
- Packages created under rule 5's lighter path ship no hookimpls/entry-point line until they graduate to full capability migration under the per-module recipe.
